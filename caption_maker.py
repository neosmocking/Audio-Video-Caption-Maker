...
def get_new_name(filename, count):
    name, ext = os.path.splitext(filename)
    return f"{name}_{count}.srt"
...
# -----------------------
print("\nPilih Mode:")
print("1. Satu File Audio/Video")
print("2. Satu Folder Audio/Video")
...
model = whisper.load_model(model_name, device=device)  # compute_type otomatis
